<template>
    ...
    <div class="container">
        ...
        <div class="content">
                ...
                <scroller>
                    <cube-slide ref="slide" :data="Banneritems" class="banner">
                        <cube-slide-item v-for="(item, index) in Banneritems" :key="index">
                            <a @click="toNativeBanner(item)">
                                <img :src="item.img">
                            </a>
                        </cube-slide-item>
                    </cube-slide>
                    <grid :show-lr-borders="false" :show-vertical-dividers="false" class="icons_box">
                        <grid-item :link="{ path: item.path}" v-for="(item,index) in routerLinkArr" :key="item.name" @click.prevent.native="handleClick(item,index)">
            ...
            <div class="fixBox">
                <a href="javascript:;" v-if="$util.isAndroid()" @click="showDialog"></a>
                <a v-else href="tel:13501132218"></a>
            </div>
        </div>
    </div>
</template>
