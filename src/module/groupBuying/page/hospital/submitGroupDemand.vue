  ...
  <div class="container submitGroupDemand">
    ...
    <div class="content">
      <div class="scroll-list-wrap">
        <cube-scroll ref="scroll" :options="{click:false}">
          ...
          submitBtnClick() {
              ...
              if (this.$route.query.groupTypeCode != "SHTG") {
                  if (getSubmitInfo.application == "") {
                      Toast({
                          message: this.toastApplicationText,
                          duration: 1000
                      });
                      this.submitBtnStatus = true;
                      return;
                  ...
                  if (getSubmitInfo.params.length == 0) {
                      ...
                      this.submitData.params = JSON.stringify(
              ...
              if (
                  ...
                  if (this.submitData.brandList.length == 0) {
                      ...
                      this.submitData.brandList = JSON.stringify(
                          this.submitData.brandList
                      );
                  }
              }
              ...
              if (this.$route.query.groupTypeCode == "SHTG") {
                  ...
                  if (getSubmitInfo.deviceCheckNum == "") {
                      ...
                      this.submitData.deviceCheckNum =
                          getSubmitInfo.deviceCheckNum;
                  }
              ...
              if (getSubmitInfo.loadTime.flag == "") {
                  ...
                  this.submitData.loadTime = JSON.stringify(
                      getSubmitInfo.loadTime
                  );
              }
                          ...
                          data => {
                              ...
                              if (data.groupPurchaseType.isMore) {
                                  if (data.brandList.length == 1) {
                                      ...
                                      data.brandFirstId =
                                          data.brandList[0].brand.brandId;
                                      data.brandSecondId = "";
                                      data.brandThirdId = "";
                                      data.brandFirstName = data.brandList[0]
                                          .brand.aliasName
                                      ...
                                      data.brandFirst = [data.brandList[0].brand];
                                      data.brandSecond = [
                                          data.brandList[1].brand
                                      ];
                                      data.brandThird = initialValue;
                                      data.brandFirstId =
                                          data.brandList[0].brand.brandId;
                                      data.brandSecondId =
                                          data.brandList[1].brand.brandId;
                                      data.brandThirdId = "";
                                      data.brandFirstName = data.brandList[0]
                                          .brand.aliasName
                                          ? data.brandList[0].brand.aliasName
                                          : data.brandList[0].brand.brandName;
                                      data.brandSecondName = data.brandList[1]
                                          .brand.aliasName
                                      ...
                                      data.brandSecondId =
                                          data.brandList[1].brand.brandId;
                                      data.brandThirdId =
                                          data.brandList[2].brand.brandId;
                                      data.brandFirstName = data.brandList[0]
                                          .brand.aliasName
                                          ? data.brandList[0].brand.aliasName
                                          : data.brandList[0].brand.brandName;
                                      data.brandSecondName = data.brandList[1]
                                          ...
                                          ? data.brandList[1].brand.aliasName
                                          : data.brandList[1].brand.brandName;
                                      data.brandThirdName = data.brandList[2]
                                          .brand.aliasName
                                  ...
                                  data.brandName = data.brandList[0].brand
                                      .aliasName
                                      ? data.brandList[0].brand.aliasName
                                      : data.brandList[0].brand.brandName;
