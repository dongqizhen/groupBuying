  ...
  export default {
      ...
      watch: {
          info() {
              console.log(
                  "变化的数据",
                  this.$store.state.page.submitGroupDemand.SBTG
              );
          }
      },
      methods: {
                      ...
                      this.$router.push({
                          ...
                          query: {
                              ...
                              vuexSelectValue: this.$store.state.page
                                  .submitGroupDemand.SBTG.productLine
                          }
                      });
                  } else {
                      Toast("请先选择需求类型");
              ...
              if (this.info.productLineId) {
                  ...
                  this.$router.push({
                      ...
                      query: {
                          ...
                          type: index,
                          vuexSelectValue: this.$store.state.page
                              .submitGroupDemand.SBTG[productBrand]
                      }
                  });
              } else {
              ...
              if (brandId) {
                  ...
                  this.$router.push({
                      ...
                      query: {
                          ...
                          isMultiple: true,
                          vuexSelectValue: this.$store.state.page
                              .submitGroupDemand.SBTG[productModel]
                      }
                  });
              } else {
              ...
              if (this.$route.query.groupPurchaseTypeId) {
                  ...
                  this.$router.push({
                      ...
                      query: {
                          ...
                          page: "submitGroupDemand",
                          vuexSelectValue: this.$store.state.page
                              .submitGroupDemand.SBTG.loadTime
                      }
                  });
              } else {
                  Toast("请先选择团购需求类型");
      ...
      activated() {
          this.info.productLineName = _.join(
              _.map(
                  ...
                  this.$store.state.page.submitGroupDemand.SBTG.productLine[0]
                      .aliasName
                      ? "aliasName"
                      : "productLineName"
              ),
          ...
          this.info.brandFirstName = _.join(
              _.map(
                  ...
                  this.$store.state.page.submitGroupDemand.SBTG.brandFirst[0]
                      .aliasName
                      ? "aliasName"
                      : "brandName"
              ),
          ...
          this.info.brandSecondName = _.join(
              _.map(
                  ...
                  this.$store.state.page.submitGroupDemand.SBTG.brandSecond[0]
                      .aliasName
                      ? "aliasName"
                      : "brandName"
              ),
          ...
          this.info.brandThirdName = _.join(
              _.map(
                  ...
                  this.$store.state.page.submitGroupDemand.SBTG.brandThird[0]
                      .aliasName
                      ? "aliasName"
                      : "brandName"
              ),
