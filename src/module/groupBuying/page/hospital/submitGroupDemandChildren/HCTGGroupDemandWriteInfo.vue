    ...
    <div class="selectBrand">
      ...
      <ul>
        ...
        <li @click="jumpToModel(0)">
          <a>
            <span>型号：</span>
             <cube-input placeholder="请选择型号" v-model="info.modelFirstName" :disabled="true">
      ...
      <ul>
        ...
        <li @click="jumpToModel(1)">
          <a>
            <span>型号：</span>
             <cube-input placeholder="请选择型号" v-model="info.modelSecondName" :disabled="true">
...
export default {
  ...
  computed: {
    info() {
      return this.$store.state.page.submitGroupDemand.HCTG;
    }
  },
  watch: {
    info() {
      console.log("变化的数据", this.$store.state.page.submitGroupDemand.HCTG);
    }
  },
  methods: {
    ...mapMutations([
    ...
    saveNumValue() {
      this.HCTGNumSave(this.info.num);
    },
    savePriceValue() {
      this.HCTGPriceSave(this.info.price);
    },
    saveApplicationValue() {
      this.HCTGApplicationSave(this.info.application);
    },
    saveIntroduceValue() {
      this.HCTGIntroduceSave(this.info.introduce);
    },
    //选择产品线
    jumpProductCateGory() {
        ...
        if (this.$route.query.groupPurchaseTypeId) {
          ...
          this.$router.push({
            ...
            query: {
              ...
              vuexSelectValue: this.$store.state.page.submitGroupDemand.HCTG
                .productLine
            }
          });
        } else {
  ...
  activated() {
    this.info.productLineName = _.join(
      _.map(
        this.$store.state.page.submitGroupDemand.HCTG.productLine,
        this.$store.state.page.submitGroupDemand.HCTG.productLine[0].aliasName
          ? "aliasName"
          : "productLineName"
      ),
      ","
    ...
    this.info.brandFirstName = _.join(
      _.map(
        this.$store.state.page.submitGroupDemand.HCTG.brandFirst,
        this.$store.state.page.submitGroupDemand.HCTG.brandFirst[0].aliasName
          ? "aliasName"
          : "brandName"
      ),
      ","
    ...
    this.info.brandSecondName = _.join(
      _.map(
        this.$store.state.page.submitGroupDemand.HCTG.brandSecond,
        this.$store.state.page.submitGroupDemand.HCTG.brandSecond[0].aliasName
          ? "aliasName"
          : "brandName"
      ),
      ","
    ...
    this.info.brandThirdName = _.join(
      _.map(
        this.$store.state.page.submitGroupDemand.HCTG.brandThird,
        this.$store.state.page.submitGroupDemand.HCTG.brandThird[0].aliasName
          ? "aliasName"
          : "brandName"
      ),
      ","
    ...
    // this.info.modelFirst = this.$store.state.page.submitGroupDemand.HCTG.modelFirst;
    // this.info.modelSecond = this.$store.state.page.submitGroupDemand.HCTG.modelSecond;
    // this.info.modelThird = this.$store.state.page.submitGroupDemand.HCTG.modelThird;
    this.info.mainParamsName = _.join(
      _.map(this.$store.state.page.submitGroupDemand.HCTG.params, "name"),
      ","
    );
    this.info.showLoadTime = this.$store.state.page.submitGroupDemand.HCTG
      .loadTime.year
      ? this.$store.state.page.submitGroupDemand.HCTG.loadTime.year +
        "年" +
        this.$store.state.page.submitGroupDemand.HCTG.loadTime.quarter
      : "";
    if (this.info.productLineId) {
      _getData(
