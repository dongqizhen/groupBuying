    ...
    export default {
        ...
        watch: {
            info() {
                console.log(
                    "变化的数据",
                    this.$store.state.page.submitGroupDemand.HCTG
                );
            }
        },
        methods: {
                        ...
                        this.$router.push({
                            ...
                            query: {
                                ...
                                vuexSelectValue: this.$store.state.page
                                    .submitGroupDemand.HCTG.productLine
                            }
                        });
                    } else {
                        Toast("请先选择需求类型");
                ...
                if (this.info.productLineId) {
                    ...
                    this.$router.push({
                        ...
                        query: {
                            ...
                            type: index,
                            vuexSelectValue: this.$store.state.page
                                .submitGroupDemand.HCTG[productBrand]
                        }
                    });
                } else {
                ...
                if (brandId) {
                    ...
                    this.$router.push({
                        ...
                        query: {
                            ...
                            isMultiple: true,
                            vuexSelectValue: this.$store.state.page
                                .submitGroupDemand.HCTG[productModel]
                        }
                    });
                } else {
        ...
        activated() {
            this.info.productLineName = _.join(
                _.map(
                    ...
                    this.$store.state.page.submitGroupDemand.HCTG.productLine[0]
                        .aliasName
                        ? "aliasName"
                        : "productLineName"
                ),
            ...
            this.info.brandFirstName = _.join(
                _.map(
                    ...
                    this.$store.state.page.submitGroupDemand.HCTG.brandFirst[0]
                        .aliasName
                        ? "aliasName"
                        : "brandName"
                ),
            ...
            this.info.brandSecondName = _.join(
                _.map(
                    ...
                    this.$store.state.page.submitGroupDemand.HCTG.brandSecond[0]
                        .aliasName
                        ? "aliasName"
                        : "brandName"
                ),
            ...
            this.info.brandThirdName = _.join(
                _.map(
                    ...
                    this.$store.state.page.submitGroupDemand.HCTG.brandThird[0]
                        .aliasName
                        ? "aliasName"
                        : "brandName"
                ),
            ...
            if (this.info.productLineId) {
                _getData(
                    ...
                    data => {
                        ...
                        this.info.histroyTotalDemandNum =
                            data.histroyTotalDemandNum;
