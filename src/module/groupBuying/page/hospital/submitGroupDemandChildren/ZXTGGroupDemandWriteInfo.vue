  ...
  export default {
      ...
      watch: {
          info() {
              console.log(
                  "变化的数据",
                  this.$store.state.page.submitGroupDemand.ZXTG
              );
          }
      },
      methods: {
                      ...
                      this.$router.push({
                          ...
                          query: {
                              ...
                              vuexSelectValue: this.$store.state.page
                                  .submitGroupDemand.ZXTG.productLine
                          }
                      });
                  } else {
                      Toast("请先选择需求类型");
      ...
      activated() {
          this.info.productLineName = _.join(
              _.map(
                  ...
                  this.$store.state.page.submitGroupDemand.ZXTG.productLine[0]
                      .aliasName
                      ? "aliasName"
                      : "productLineName"
              ),
