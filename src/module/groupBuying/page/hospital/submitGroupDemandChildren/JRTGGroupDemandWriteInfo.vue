  ...
  export default {
      ...
      watch: {
          info() {
              console.log(
                  "变化的数据",
                  this.$store.state.page.submitGroupDemand.JRTG
              );
          }
      },
      methods: {
                      ...
                      this.$router.push({
                          ...
                          query: {
                              ...
                              vuexSelectValue: this.$store.state.page
                                  .submitGroupDemand.JRTG.productLine
                          }
                      });
                  } else {
                      Toast("请先选择需求类型");
              ...
              if (this.$route.query.groupPurchaseId) {
                  ...
                  this.$router.push({
                      ...
                      query: {
                          ...
                          page: "submitGroupDemand",
                          vuexSelectValue: this.$store.state.page
                              .submitGroupDemand.JRTG.loadTime,
      ...
      activated() {
          this.info.productLineName = _.join(
              _.map(
                  ...
                  this.$store.state.page.submitGroupDemand.JRTG.productLine[0]
                      .aliasName
                      ? "aliasName"
                      : "productLineName"
              ),
