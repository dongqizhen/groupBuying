  ...
  export default {
      ...
      watch: {
          info() {
              console.log(
                  "变化的数据",
                  this.$store.state.page.submitGroupDemand.XXHTG
              );
          }
      },
      methods: {
                      ...
                      this.$router.push({
                          ...
                          query: {
                              ...
                              vuexSelectValue: this.$store.state.page
                                  .submitGroupDemand.XXHTG.productLine
                          }
                      });
                  } else {
                      Toast("请先选择需求类型");
              ...
              if (this.$route.query.groupPurchaseTypeId) {
                  ...
                  this.$router.push({
                      ...
                      query: {
                          ...
                          page: "submitGroupDemand",
                          vuexSelectValue: this.$store.state.page
                              .submitGroupDemand.XXHTG.params
                      }
                  });
              } else {
                  Toast("请先选择团购需求类型");
              ...
              if (this.$route.query.groupPurchaseId) {
                  ...
                  this.$router.push({
                      ...
                      query: {
                          ...
                          page: "submitGroupDemand",
                          vuexSelectValue: this.$store.state.page
                              .submitGroupDemand.XXHTG.loadTime,
      ...
      activated() {
          this.info.productLineName = _.join(
              _.map(
                  ...
                  this.$store.state.page.submitGroupDemand.XXHTG.productLine[0]
                      .aliasName
                      ? "aliasName"
                      : "productLineName"
              ),
          ...
          this.info.brandName = _.join(
              _.map(
                  ...
                  this.$store.state.page.submitGroupDemand.XXHTG.brand[0]
                      .aliasName
                      ? "aliasName"
                      : "brandName"
              ),
          ...
          this.info.mainParamsName = _.join(
              _.map(
                  this.$store.state.page.submitGroupDemand.XXHTG.params,
                  "name"
              ),
              ","
          );
