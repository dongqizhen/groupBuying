    ...
    <div class="groupDemandWriteInfo">
        <ul>
            ...
            <li class="number">
                ...
                <p>
                    本次团购,{{info.productLineName}}信息化已累计申报<span>{{demandNum}}</span>单,历史累计申报共<span>{{histroyTotalDemandNum}}</span>单
                </p>
            </li>
            <li class="price">
                <div>
                ...
                <p>
                    本次团购,{{info.productLineName}}信息化已累计申报<span>{{demandNum}}</span>单,总预算为<span>{{totalPrice}}</span>万元
                </p>
            </li>
            <li class="clinic">
                <group>
                    <x-textarea title="应用需求:" v-model="info.application" placeholder="为保证你的采购质量及效率请详细填写信息化应用需求" autosize></x-textarea>
                </group>
            </li>
