<template>
  <div class="container">
    ...
    <div class="content">
        ...
        >
          ...
          >
            ...
            <div class="common hopeBrand">
              <ul>
                <li
                  v-for="(val,index) in resultData.brandList"
                  :key="index"
                >
                  <span>
            ...
            <div class="common param">
              ...
              <span class="paramVal">
                <ul>
                  <li
                    v-for="itemParam in resultData.params"
                    :key="itemParam.name"
                  >{{itemParam.name}}</li>
                </ul>
              </span>
              ...
              <ul v-if="commentList.length">
                ...
                >
                  <comment-list-item
                    :commentData='val'
                    :index="index"
                    v-on:delete_commit="delete_commit(val.id,index)"
                    v-on:delete_child_comment='delete_child_comment'
                  ></comment-list-item>
                </li>
              </ul>
              <div
      ...
      <submit-comment
        :id="resultData.id"
        v-on:comment_success="comment_success"
      ></submit-comment>
    </div>
  </div>
</template>
      ...
      async getCommentList(currentPage) {
        await _getData(
          "/server_pro/groupPurchaseHospital!request.action",
          {
            ...
            userid: this.$USER_INFO.userid || this.$route.query.userid,
            params: {
