<template>
  <div class="container myCompanyGroupBuy">
    <Header :isSearchHide="false" title="我的团购（企业）">
      <router-link :to="{path:'/uploadedProducts',query:{id:this.$store.state.userCompanyIdOrHospitalId}}" slot="explain" @click.native="setTransition('turn-on')">产品清单</router-link>
    </Header>
    <div class="content">
