                ...
                <cube-scroll ref="scroll">
                    ...
                    <div class="productBasicInfromation">
                        <basic-title title="产品基本信息" imgurl="../static/images/basicInformation.png">
                            ...
                            <a slot="check" class="server" v-else href="tel:13501132218">
                                <i></i>
                                客服
                            </a>
                        </basic-title>
                    ...
                    <div class="img_upload">
                        ...
                        <div class="upload_container">
                            <cube-upload ref="upload" v-model="action.files" :action="action" :simultaneous-uploads="3" @files-added="addedHandler" @file-removed="fileRemove" @file-success="fileSuccess" />
                            <span>点击上传产品图片</span>
                        </div>
                    </div>
    ...
    export default {
        data() {
            return {
                ...
                action: {
                    target: `${this.$API_URL.FILE_URL}/server/imageupload`,
                    files: []
                },
                groupUnderWayList: [],
                productLineId: "",
        ...
        methods: {
            ...
            submitBtnClick() {
                ...
                if (this.action.files.length == 0) {
                    ...
                    if (this.submitData.imageUrl[0] == "fail") {
                        Toast({
                            message: "图片上传失败，请上传小于1M的图片",
                            duration: 1000
                        });
                        this.submitBtnStatus = true;
                        return;
                    }
                    console.log(this.submitData.imageUrl);
                }
