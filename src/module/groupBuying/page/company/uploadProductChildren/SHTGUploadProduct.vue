    ...
    <ul>
        ...
        <li>
            <a>
                ...
                <cube-input class="responseTime needsclick" type="number" placeholder="请输入响应时间" @input="saveResponseTimeValue" v-model="info.responseTime">
...
export default {
  data() {
    return { types, currentIdx: null, y: 0 };
  },
  computed: {
    info() {
  ...
  watch: {
    info() {
      console.log("变化数据：", this.$store.state.page.uploadProduct.SHTG);
    }
  },
  components: {
    Group,
  ...
  methods: {
    ...
    addClass(i) {
      ...
      this.uploadProductSHTGMaintenanceTypeSave(this.info.maintenanceType);
    },
    jumpProductCateGory() {
      if (this.$route.query.groupTypeCode) {
        ...
        this.$router.push({
          ...
          query: {
            ...
            page: "uploadProduct",
            vuexSelectValue: this.$store.state.page.uploadProduct.SHTG
              .productLine
          }
        });
      } else {
      ...
      if (this.info.productLineId) {
        ...
        this.$router.push({
          ...
          query: {
            ...
            groupTypeCode: this.$route.query.groupTypeCode,
            page: "uploadProduct",
            vuexSelectValue: this.$store.state.page.uploadProduct.SHTG.brand
          }
        });
      } else {
        Toast("请先选择分类");
      ...
      if (this.info.brandId) {
        ...
        this.$router.push({
          ...
          query: {
            ...
            groupTypeCode: this.$route.query.groupTypeCode,
            page: "uploadProduct",
            vuexSelectValue: this.$store.state.page.uploadProduct.SHTG.model
          }
        });
      } else {
        Toast("请先选择品牌");
  ...
  activated() {
    this.info.productLineName = _.join(
      _.map(
        ...
        this.$store.state.page.uploadProduct.SHTG.productLine[0].aliasName
          ? "aliasName"
          : "productLineName"
      ),
      ","
