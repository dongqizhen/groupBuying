<template>
    <div class="container">
        ...
        <div class="content">
            <scroller :class="this.$route.query.come==1||this.$store.state.userType=='company'?'height':''">
                ...
                <div class="proBaseInfo">
                    ...
                    <div class="proPrice">
                        ...
                        <span :class="data.isOpen || $USER_INFO.userid==data.companyUserId?'price':'textStyle'">{{data.isOpen || $USER_INFO.userid==data.companyUserId ? data.price:"团购办现场宣布价格"}}</span>

                        <!-- <span :class="data.isOpen ||$USER_INFO.userid==data.companyUserId?'point':'textStyle'">{{data.isOpen || $USER_INFO.userid==data.companyUserId?data.price:""}}</span> -->
            ...
            <footer-menu :isStore="isStore" v-on:selectedLabel="selectLabel" v-if="this.$route.query.come==1||this.$store.state.userType=='company'?false:true"></footer-menu>
        </div>
    </div>
</template>
...
<script>
    ...
    import { directMessages } from "../../components/mixin/mixin";
                ...
                switch (obj.label) {
                    case "查看商家":
                        ...
                        this.$router.push({
                            ...
                            query: {
                                ...
                                userId: this.data.companyUserId
                            }
                        });
                        break;
                    case "私信商家":
                    ...
                    case "加入我的团购需求表":
                        _getData(
                            ...
                            {
                                method: "joinMyGroupPurchaseHospitalDemand",
                                params: {
                                    groupPurchaseCompanyProductId: this.data.id
                                }
                            },
                            data => {
                                console.log(data);
                            ...
                            this.$router.push({
                                path: "/demandTable",
                                query: {
                                    id: this.$store.state.userCompanyIdOrHospitalId
                                }
                            });
                        });
                        break;
