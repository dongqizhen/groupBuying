<template>
  ...
  <div
    class="clearfix commentList"
    @click="toNativeCommentDetails(commentData.id,index)"
  >
    <div
      class="left"
      @click.stop="friendInfo(commentData.userId)"
    >

      <img
        v-lazy="commentData.userImageUrl"
        alt=""
      >
    </div>
    <div class="right">
      <div class="nameBox">
        ...
        <div
          ...
          @click.stop="triggle(commentData.id)"
        >
      ...
      <div class="replyBtn">
        ...
        <span
          class="delete"
          v-if="($USER_INFO.userid==commentData.userId || $route.query.userid==commentData.userId)"
          @click.stop="delete_commit(commentData.id)"
        >删除</span>
      </div>
      <ul
        class="reply"
        v-if="commentData.replyList.length"
      >
        <li
          v-for="(val,index) in commentData.replyList"
          :key="index"
        >
      ...
      .nameBox {
        ...
        .approve {
          ...
          i {
            ...
            margin-right: 4px;
            background: url("../../../../../static/images/approve.png") no-repeat
              left center;
